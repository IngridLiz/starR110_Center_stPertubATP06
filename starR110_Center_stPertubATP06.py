...
T = 1000 # final time
num_step = 12000 # number of time step
dt = T / num_step
...
for n in range(num_step):
    ...
    if n < 2000:
        ...
        #Create VTK files for visualization output
            vtkfile_glc = File('results_starR110_Center_stPertubATP06/glc/glc_R110_Center_stATP06_%sof12000s.pvd' % n)
            vtkfile_atp = File('results_starR110_Center_stPertubATP06/atp/atp_R110_Center_stATP06_%sof12000s.pvd' % n)
            vtkfile_adp = File('results_starR110_Center_stPertubATP06/adp/adp_R110_Center_stATP06_%sof12000s.pvd' % n)
            vtkfile_gly = File('results_starR110_Center_stPertubATP06/gly/gly_R110_Center_stATP06_%sof12000s.pvd' % n)
            vtkfile_pyr = File('results_starR110_Center_stPertubATP06/pyr/pyr_R110_Center_stATP06_%sof12000s.pvd' % n)
            vtkfile_lac = File('results_starR110_Center_stPertubATP06/lac/lac_R110_Center_stATP06_%sof12000s.pvd' % n)
